"""Secret management helpers with keyring fallback support."""
...
def get_secret(service: str, username: str) -> str | None:
    """Retrieve a stored secret or ``None`` when unavailable."""
...
def delete_secret(service: str, username: str) -> None:
    """Delete a stored secret from ``keyring`` or the environment."""
